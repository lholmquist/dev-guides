...
TODO: URL will need updating once we are in the system
...
TODO: mention that all the vector stuff could be done "offline" but we do it each time we instantiate a new chat for demo purposes
