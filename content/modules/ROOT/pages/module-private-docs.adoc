...
<1> What is this template thing
<2> what is this ZodSchema Structured Output parser thing
<3> What is this
<4> what is this
<5> what is this


TODO: rag.mjs Code Walk through

TODO: chat.mjs Code updates
...
TODO: mention something that we are just using a differnt type of runnable, but it's still a chain that can be used
...
TODO: mention something related to the output key is different for this type of runnable
