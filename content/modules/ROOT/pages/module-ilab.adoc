...
TODO: does this need java for anything else besides running the parasol app.  If not then made this is switched to installing Node to run the application?
