...
TODO: this whole next section will either need a Node.js counterpart or needs to be removed
...
END TODO: this whole next section will either need a Node.js counterpart or needs to be removed
...
TODO: title needs an update for Node.js
...
TODO: important section needs a Node.js update .  needs a bash script for those that skipped the first section
...
TODO: update references of Langchain4j
...
TODO: update references of Langchain4j
TODO: source code imagge needs to be updated
...
TODO: prompt might need to look different based on langchain.js formatting
...
TODO: might need to change the directory structure based on the front-end location
...
TODO: update needed talking about quarkus dev mode
...
TODO: update needed talking about summary and quarkus
