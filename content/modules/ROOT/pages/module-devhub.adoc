...
TODO: update paragraph for Node.js
...
TODO: THis is the front-end, so no Quarkus stuff here, but where will the front-end live?  directory structure might be different based on location
...
TODO: update for Node.js local testing
